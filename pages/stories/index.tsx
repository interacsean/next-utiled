      ...
      <ul style={{ width: '180px' }}>
        ...
        <li>
          <Box mt={1 / 2}>
            ...
            <ul>
              <li>
                <Link to="/stories/calculator/strategy-selector">
                  Strategy Selector
                </Link>
              </li>
              <li>
                <Link to="/stories/calculator/option-leg">Option Leg</Link>
              </li>
              <li>
                <Link to="/stories/calculator/stock-leg">Stock Leg</Link>
              </li>
              <li>
                <Link to="/stories/calculator/options-chain">
                  Options Chain
                </Link>
              </li>
              <li>
                <Link to="/stories/calculator/expiry-selector">
                  Expiry Selector
                </Link>
              </li>
              <li>
                <Link to="/stories/calculator/symbol-lookup">
                  Symbol lookup
                </Link>
              </li>
              <li>
                <Link to="/stories/calculator/results-summary">
                  Results Summary
                </Link>
              </li>
              <li>
                <Link to="/stories/calculator/results-matrix">
                  Results Matrix
                </Link>
              </li>
              <li>
                <Link to="/stories/calculator/results-matrix-toolbar">
                  Results Matrix Toolbar
                </Link>
              </li>
              <li>
                <Link to="/stories/calculator/current-calc-tabs">
                  CurrentCalculationTabs
                </Link>
              </li>
              <li>
                <Link to="/stories/calculator/net-summary">NetSummary</Link>
              </li>
              {/* cursor:calculator */}
            </ul>
          </Box>
        ...
        <li>
          <Box mt={1 / 2}>
            ...
            <ul>
              <li>
                <Link to="/stories/infra/redux-persistance">
                  Redux Persistance
                </Link>
              </li>
            </ul>
